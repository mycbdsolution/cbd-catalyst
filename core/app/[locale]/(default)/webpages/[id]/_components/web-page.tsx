          ...
          return (
            <>
              <header className="pb-8 @2xl:pb-12 @4xl:pb-16">
                ...
                <h1 className="mb-4 mt-8 font-heading text-4xl font-semibold tracking-tight leading-none @xl:text-5xl @4xl:text-6xl">
                  {title}
                </h1>
              </header>

              <div
                className="@-xl:[&_h2]:text-4xl prose max-w-full space-y-4 [&_h2]:font-heading [&_h2]:text-3xl [&_h2]:font-normal [&_h2]:leading-none [&_img]:mx-auto [&_img]:max-h-[600px] [&_img]:w-fit [&_img]:rounded-2xl [&_img]:object-cover"
