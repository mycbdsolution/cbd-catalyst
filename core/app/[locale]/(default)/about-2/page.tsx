    ...
    <div className="bg-white dark:bg-gray-900">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  Exclusive brands. Proven ingredients. Better health.
                  </h1>
                  <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none dark:text-gray-400">
                    My CBD Solution offers premium, nature-derived wellness products for pain relief, mood support, and whole-body balance.
                  </p>
                </div>
          ...
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                 ...
                 At My CBD Solution, we believe in empowering individuals to take charge of their mental and physical wellness 
                  with safe, effective, and trusted plant-based products. Established in 2018 by Peterson Chiropractic Clinic, our 
                  mission was born out of a desire to guide customers through the overwhelming CBD market that surged with unregulated, 
                  confusing options. We wanted to create a space where quality and transparency were paramount—where customers could 
                  differentiate between products of dubious origins and those backed by reputable science and standards.</p>

              <p className="mt-10 max-w-xl text-base/7 text-gray-700 dark:text-gray-400">
              What began as a focus on high-quality, cannabis-based wellness solutions has since evolved into a broader commitment 
                to natural health. Today, we proudly offer an expanded range of handpicked products, including functional mushroom supplements 
                and other plant-based solutions. Staying true to our philosophy of “quality over quantity,” we meticulously curate every 
                brand and product we carry, ensuring they meet our rigorous standards for safety, effectiveness, and integrity. At My CBD 
                Solution, we’re more than just a marketplace; we’re a trusted partner in your journey to better health and wellness.</p>
              </div>
        ...
        <div className="relative isolate -z-10 mt-32 sm:mt-48">
          <div className="absolute inset-x-0 top-1/2 -z-10 flex -translate-y-1/2 justify-center overflow-hidden [mask-image:radial-gradient(50%_45%_at_50%_55%,white,transparent)]">
            <svg aria-hidden="true" className="h-[40rem] w-[80rem] flex-none stroke-gray-200 dark:stroke-white/10">
              <defs>
                <pattern
                  x="50%"
                  y="50%"
              ...
              <svg x="50%" y="50%" className="overflow-visible fill-gray-50 dark:fill-gray-800">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
              ...
              <img
                ...
                width={158}
                height={48}
                className="col-span-2 hidden max-h-12 w-full object-contain lg:col-span-1 dark:block"
              />
              ...
              <img
                ...
                width={158}
                height={48}
                className="col-span-2 hidden max-h-12 w-full object-contain sm:col-start-2 lg:col-span-1 dark:block"
              />
              ...
              <img
                ...
                width={158}
                height={48}
                className="col-span-2 col-start-2 hidden max-h-12 w-full object-contain sm:col-start-auto lg:col-span-1 dark:block"
              />
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {blogPosts.map((post) => (
              ...
              >
                ...
                <div className="absolute inset-0 -z-10 bg-gradient-to-t from-gray-900 via-gray-900/40 dark:from-black/80 dark:via-black/40" />
